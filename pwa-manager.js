...
class PWAManager {
  ...
  setupInstallPrompt() {
    // PWA Installation disabled - prevent beforeinstallprompt from showing banner
    window.addEventListener('beforeinstallprompt', (e) => {
      e.preventDefault();
      this.deferredPrompt = e;
      // this.showInstallBanner(); // DISABLED - No install banner
  ...
  showInstallBanner() {
    // PWA Install banner disabled - do nothing
